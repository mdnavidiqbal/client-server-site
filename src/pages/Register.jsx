...
export default function Register() {
  ...
  return (
    ...
    >
      ...
      {/* Form box */}
      <div className="relative z-10 w-full max-w-md sm:max-w-lg md:max-w-md lg:max-w-md bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-6 sm:p-8 shadow-2xl text-white">
        ...
        <div className="my-4 flex items-center justify-center">
          ...
          <p className="mx-2 text-gray-300 text-sm">OR</p>
          <div className="h-px bg-gray-400 w-1/4"></div>
        </div>
        ...
        <button
          onClick={googleLogin}
          className="w-full btn bg-white text-black border border-gray-300 hover:bg-gray-100 flex items-center justify-center gap-2 transition"
        >
          <svg
